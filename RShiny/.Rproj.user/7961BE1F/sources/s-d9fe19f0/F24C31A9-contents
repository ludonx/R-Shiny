...
observeEvent(input$ActionQuickSave_requetes_Les_Genes,{
  ...
  for(i in 1:nrow(globalInformation$modules$Catalogue$dataFrameRequete)){
    if(input[[paste0("checkboxInput_Mes_contraintes_Les_Genes",globalInformation$modules$Catalogue$dataFrameRequete[i,"id_collection"])]]==F)
      {
        listeQueries<-
          append(
            listeQueries,
            myQueryConstraintN(input[[paste0("select_Mes_contraintes_Les_Genes",globalInformation$modules$Catalogue$dataFrameRequete[i,"id_collection"])]])
      ...
      listeQueries<-
        append(
          listeQueries,
          myQueryConstraintN_OR(input[[paste0("select_Mes_contraintes_Les_Genes",globalInformation$modules$Catalogue$dataFrameRequete[i,"id_collection"])]])
